...
class ActivityNew : AppCompatActivity() {
    ...
    private val sensorListener: SensorEventListener = object : SensorEventListener {
        override fun onSensorChanged(event: SensorEvent) {
            ...
            if (acceleration > 12) {
                Toast.makeText(applicationContext, "Shake detected.  Clearing fields...", Toast.LENGTH_SHORT).show()
 ...
 *
 *  Title: How to Detect Shake Event in Android?
 *  Author: aashaypawar
 *  Date: 14 Feb, 2022
 *  URL: https://www.geeksforgeeks.org/how-to-detect-shake-event-in-android/
 ***************************************************************************************/